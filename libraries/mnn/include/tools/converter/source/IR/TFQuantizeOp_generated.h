...
struct QuantizedAdd FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_activationType(FusedActivation _activationType) {
  ...
  QuantizedParam *mutable_input1QuantizedParam() {
    return GetPointer<QuantizedParam *>(VT_INPUT1QUANTIZEDPARAM);
  }
  const QuantizedParam *input2QuantizedParam() const {
    return GetPointer<const QuantizedParam *>(VT_INPUT2QUANTIZEDPARAM);
  }
  QuantizedParam *mutable_input2QuantizedParam() {
    return GetPointer<QuantizedParam *>(VT_INPUT2QUANTIZEDPARAM);
  }
  const QuantizedParam *outputQuantizedParam() const {
    return GetPointer<const QuantizedParam *>(VT_OUTPUTQUANTIZEDPARAM);
  }
  QuantizedParam *mutable_outputQuantizedParam() {
    return GetPointer<QuantizedParam *>(VT_OUTPUTQUANTIZEDPARAM);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct Dequantize FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  QuantizedParam *mutable_inputQuantizedParam() {
    return GetPointer<QuantizedParam *>(VT_INPUTQUANTIZEDPARAM);
  }
  QuantizeMode mode() const {
    return static_cast<QuantizeMode>(GetField<int8_t>(VT_MODE, 0));
  }
  bool mutate_mode(QuantizeMode _mode) {
  ...
  bool mutate_modelFormat(ModeFormat _modelFormat) {
    return SetField<int8_t>(VT_MODELFORMAT, static_cast<int8_t>(_modelFormat), 0);
  }
  DataType type() const {
    return static_cast<DataType>(GetField<int32_t>(VT_TYPE, 0));
  }
  bool mutate_type(DataType _type) {
...
struct QuantizedAvgPool FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_outputActivationMax(int32_t _outputActivationMax) {
    return SetField<int32_t>(VT_OUTPUTACTIVATIONMAX, _outputActivationMax, 0);
  }
  int32_t outputActivationMin() const {
    return GetField<int32_t>(VT_OUTPUTACTIVATIONMIN, 0);
  }
  bool mutate_outputActivationMin(int32_t _outputActivationMin) {
    return SetField<int32_t>(VT_OUTPUTACTIVATIONMIN, _outputActivationMin, 0);
  }
...
struct QuantizedBiasAdd FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_inputType(DataType _inputType) {
    return SetField<int32_t>(VT_INPUTTYPE, static_cast<int32_t>(_inputType), 0);
  }
  int32_t max() const {
    return GetField<int32_t>(VT_MAX, 0);
  }
  bool mutate_max(int32_t _max) {
    return SetField<int32_t>(VT_MAX, _max, 0);
  }
  int32_t min() const {
    return GetField<int32_t>(VT_MIN, 0);
  }
  bool mutate_min(int32_t _min) {
    return SetField<int32_t>(VT_MIN, _min, 0);
  }
  DataType outputType() const {
    return static_cast<DataType>(GetField<int32_t>(VT_OUTPUTTYPE, 0));
  }
  bool mutate_outputType(DataType _outputType) {
    return SetField<int32_t>(VT_OUTPUTTYPE, static_cast<int32_t>(_outputType), 0);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct QuantizedConcat FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<float> *mutable_inputScale() {
    return GetPointer<flatbuffers::Vector<float> *>(VT_INPUTSCALE);
  }
  ...
  flatbuffers::Vector<int32_t> *mutable_inputZeroPoint() {
    return GetPointer<flatbuffers::Vector<int32_t> *>(VT_INPUTZEROPOINT);
  }
  const QuantizedParam *outputQuantizedParam() const {
    return GetPointer<const QuantizedParam *>(VT_OUTPUTQUANTIZEDPARAM);
  }
...
struct QuantizedSoftmax FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_inputScale(float _inputScale) {
    return SetField<float>(VT_INPUTSCALE, _inputScale, 0.0f);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct QuantizeV2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_roundMode(QuantizeRoundMode _roundMode) {
...
struct TfQuantizedConv2D FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_biasflag(bool _biasflag) {
    return SetField<uint8_t>(VT_BIASFLAG, static_cast<uint8_t>(_biasflag), 0);
  }
  ...
  flatbuffers::Vector<uint8_t> *mutable_weight() {
    return GetPointer<flatbuffers::Vector<uint8_t> *>(VT_WEIGHT);
  }
  FusedActivation activationType() const {
    return static_cast<FusedActivation>(GetField<int8_t>(VT_ACTIVATIONTYPE, 0));
  }
  ...
  bool mutate_multiplier(int32_t _multiplier) {
    return SetField<int32_t>(VT_MULTIPLIER, _multiplier, 0);
  }
  int32_t outMax() const {
    return GetField<int32_t>(VT_OUTMAX, 0);
  }
  bool mutate_outMax(int32_t _outMax) {
    return SetField<int32_t>(VT_OUTMAX, _outMax, 0);
  }
  int32_t outMin() const {
    return GetField<int32_t>(VT_OUTMIN, 0);
  }
  bool mutate_outMin(int32_t _outMin) {
    return SetField<int32_t>(VT_OUTMIN, _outMin, 0);
  }
  int32_t shift() const {
    return GetField<int32_t>(VT_SHIFT, 0);
  }
  bool mutate_shift(int32_t _shift) {
    return SetField<int32_t>(VT_SHIFT, _shift, 0);
  }
  const QuantizedParam *biasQuantizedParam() const {
    return GetPointer<const QuantizedParam *>(VT_BIASQUANTIZEDPARAM);
  }
  QuantizedParam *mutable_biasQuantizedParam() {
    return GetPointer<QuantizedParam *>(VT_BIASQUANTIZEDPARAM);
  }
  int32_t depthMultiplier() const {
    return GetField<int32_t>(VT_DEPTHMULTIPLIER, 0);
  }
  bool mutate_depthMultiplier(int32_t _depthMultiplier) {
    return SetField<int32_t>(VT_DEPTHMULTIPLIER, _depthMultiplier, 0);
  }
  const QuantizedParam *filterQuantizedParam() const {
    return GetPointer<const QuantizedParam *>(VT_FILTERQUANTIZEDPARAM);
  }
  QuantizedParam *mutable_filterQuantizedParam() {
    return GetPointer<QuantizedParam *>(VT_FILTERQUANTIZEDPARAM);
  }
  const QuantizedParam *inputQuantizedParam() const {
    return GetPointer<const QuantizedParam *>(VT_INPUTQUANTIZEDPARAM);
  }
