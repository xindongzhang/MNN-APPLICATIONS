...
struct Convolution2DCommon FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_padX(int32_t _padX) {
    return SetField<int32_t>(VT_PADX, _padX, 0);
  }
  int32_t padY() const {
    return GetField<int32_t>(VT_PADY, 0);
  }
  bool mutate_padY(int32_t _padY) {
    return SetField<int32_t>(VT_PADY, _padY, 0);
  }
  int32_t kernelX() const {
    return GetField<int32_t>(VT_KERNELX, 1);
  }
  bool mutate_kernelX(int32_t _kernelX) {
    return SetField<int32_t>(VT_KERNELX, _kernelX, 1);
  }
  int32_t kernelY() const {
    return GetField<int32_t>(VT_KERNELY, 1);
  }
  bool mutate_kernelY(int32_t _kernelY) {
    return SetField<int32_t>(VT_KERNELY, _kernelY, 1);
  }
  int32_t strideX() const {
    return GetField<int32_t>(VT_STRIDEX, 1);
  }
  bool mutate_strideX(int32_t _strideX) {
    return SetField<int32_t>(VT_STRIDEX, _strideX, 1);
  }
  int32_t strideY() const {
    return GetField<int32_t>(VT_STRIDEY, 1);
  }
  bool mutate_strideY(int32_t _strideY) {
    return SetField<int32_t>(VT_STRIDEY, _strideY, 1);
  }
  int32_t dilateX() const {
    return GetField<int32_t>(VT_DILATEX, 1);
  }
  bool mutate_dilateX(int32_t _dilateX) {
    return SetField<int32_t>(VT_DILATEX, _dilateX, 1);
  }
  int32_t dilateY() const {
    return GetField<int32_t>(VT_DILATEY, 1);
  }
  bool mutate_dilateY(int32_t _dilateY) {
    return SetField<int32_t>(VT_DILATEY, _dilateY, 1);
  }
  PadMode padMode() const {
    return static_cast<PadMode>(GetField<int8_t>(VT_PADMODE, 0));
  }
  bool mutate_padMode(PadMode _padMode) {
  ...
  bool mutate_group(int32_t _group) {
    return SetField<int32_t>(VT_GROUP, _group, 1);
  }
  int32_t outputCount() const {
    return GetField<int32_t>(VT_OUTPUTCOUNT, 0);
  }
  bool mutate_outputCount(int32_t _outputCount) {
    return SetField<int32_t>(VT_OUTPUTCOUNT, _outputCount, 0);
  }
  int32_t inputCount() const {
    return GetField<int32_t>(VT_INPUTCOUNT, 0);
  }
  bool mutate_inputCount(int32_t _inputCount) {
    return SetField<int32_t>(VT_INPUTCOUNT, _inputCount, 0);
  }
  bool relu() const {
    return GetField<uint8_t>(VT_RELU, 0) != 0;
  }
  bool mutate_relu(bool _relu) {
    return SetField<uint8_t>(VT_RELU, static_cast<uint8_t>(_relu), 0);
  }
  bool relu6() const {
    return GetField<uint8_t>(VT_RELU6, 0) != 0;
  }
  bool mutate_relu6(bool _relu6) {
    return SetField<uint8_t>(VT_RELU6, static_cast<uint8_t>(_relu6), 0);
  }
...
struct IDSTQuan FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<float> *mutable_alpha() {
    return GetPointer<flatbuffers::Vector<float> *>(VT_ALPHA);
  }
  int32_t type() const {
  ...
  bool mutate_useInt32(bool _useInt32) {
    return SetField<uint8_t>(VT_USEINT32, static_cast<uint8_t>(_useInt32), 0);
  }
  float quantScale() const {
    return GetField<float>(VT_QUANTSCALE, 0.0f);
  }
  bool mutate_quantScale(float _quantScale) {
    return SetField<float>(VT_QUANTSCALE, _quantScale, 0.0f);
  }
  float scaleIn() const {
    return GetField<float>(VT_SCALEIN, 0.0f);
  }
  bool mutate_scaleIn(float _scaleIn) {
    return SetField<float>(VT_SCALEIN, _scaleIn, 0.0f);
  }
  float scaleOut() const {
    return GetField<float>(VT_SCALEOUT, 0.0f);
  }
  bool mutate_scaleOut(float _scaleOut) {
    return SetField<float>(VT_SCALEOUT, _scaleOut, 0.0f);
  }
  int32_t aMax() const {
    return GetField<int32_t>(VT_AMAX, 0);
  }
  bool mutate_aMax(int32_t _aMax) {
    return SetField<int32_t>(VT_AMAX, _aMax, 0);
  }
  int32_t aMin() const {
    return GetField<int32_t>(VT_AMIN, 0);
  }
  bool mutate_aMin(int32_t _aMin) {
    return SetField<int32_t>(VT_AMIN, _aMin, 0);
  }
  int32_t readType() const {
    return GetField<int32_t>(VT_READTYPE, 0);
  }
  bool mutate_readType(int32_t _readType) {
    return SetField<int32_t>(VT_READTYPE, _readType, 0);
  }
  bool has_scaleInt() const {
    return GetField<uint8_t>(VT_HAS_SCALEINT, 0) != 0;
  }
  bool mutate_has_scaleInt(bool _has_scaleInt) {
    return SetField<uint8_t>(VT_HAS_SCALEINT, static_cast<uint8_t>(_has_scaleInt), 0);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct QuantizedFloatParam FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<int8_t> *mutable_weight() {
    return GetPointer<flatbuffers::Vector<int8_t> *>(VT_WEIGHT);
  }
  const flatbuffers::Vector<int32_t> *bias() const {
    return GetPointer<const flatbuffers::Vector<int32_t> *>(VT_BIAS);
  }
  flatbuffers::Vector<int32_t> *mutable_bias() {
    return GetPointer<flatbuffers::Vector<int32_t> *>(VT_BIAS);
  }
  ...
  flatbuffers::Vector<float> *mutable_tensorScale() {
    return GetPointer<flatbuffers::Vector<float> *>(VT_TENSORSCALE);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct Convolution2D FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  Convolution2DCommon *mutable_common() {
    return GetPointer<Convolution2DCommon *>(VT_COMMON);
  }
  ...
  IDSTQuan *mutable_quanParameter() {
    return GetPointer<IDSTQuan *>(VT_QUANPARAMETER);
  }
  const QuantizedFloatParam *symmetricQuan() const {
    return GetPointer<const QuantizedFloatParam *>(VT_SYMMETRICQUAN);
  }
  QuantizedFloatParam *mutable_symmetricQuan() {
    return GetPointer<QuantizedFloatParam *>(VT_SYMMETRICQUAN);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct InnerProduct FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_biasTerm(int32_t _biasTerm) {
    return SetField<int32_t>(VT_BIASTERM, _biasTerm, 0);
  }
  int32_t weightSize() const {
    return GetField<int32_t>(VT_WEIGHTSIZE, 0);
  }
  bool mutate_weightSize(int32_t _weightSize) {
    return SetField<int32_t>(VT_WEIGHTSIZE, _weightSize, 0);
  }
  const flatbuffers::Vector<float> *weight() const {
    return GetPointer<const flatbuffers::Vector<float> *>(VT_WEIGHT);
  }
...
struct Pool FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_isGlobal(bool _isGlobal) {
    return SetField<uint8_t>(VT_ISGLOBAL, static_cast<uint8_t>(_isGlobal), 0);
  }
  int32_t kernelX() const {
    return GetField<int32_t>(VT_KERNELX, 0);
  }
  bool mutate_kernelX(int32_t _kernelX) {
    return SetField<int32_t>(VT_KERNELX, _kernelX, 0);
  }
  int32_t kernelY() const {
    return GetField<int32_t>(VT_KERNELY, 0);
  }
  bool mutate_kernelY(int32_t _kernelY) {
    return SetField<int32_t>(VT_KERNELY, _kernelY, 0);
  }
  int32_t strideX() const {
    return GetField<int32_t>(VT_STRIDEX, 0);
  }
  bool mutate_strideX(int32_t _strideX) {
    return SetField<int32_t>(VT_STRIDEX, _strideX, 0);
  }
  int32_t strideY() const {
    return GetField<int32_t>(VT_STRIDEY, 0);
  }
  bool mutate_strideY(int32_t _strideY) {
    return SetField<int32_t>(VT_STRIDEY, _strideY, 0);
  }
  PoolType type() const {
    return static_cast<PoolType>(GetField<int8_t>(VT_TYPE, 0));
  }
  bool mutate_type(PoolType _type) {
  ...
  bool mutate_padType(PoolPadType _padType) {
    return SetField<int8_t>(VT_PADTYPE, static_cast<int8_t>(_padType), 0);
  }
  ...
  bool mutate_ceilModel(bool _ceilModel) {
    return SetField<uint8_t>(VT_CEILMODEL, static_cast<uint8_t>(_ceilModel), 1);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_PADX) &&
...
struct Relu FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_slope(float _slope) {
    return SetField<float>(VT_SLOPE, _slope, 0.0f);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct PRelu FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_slopeCount(int32_t _slopeCount) {
    return SetField<int32_t>(VT_SLOPECOUNT, _slopeCount, 0);
  }
...
struct LRN FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_regionType(int32_t _regionType) {
    return SetField<int32_t>(VT_REGIONTYPE, _regionType, 0);
  }
  int32_t localSize() const {
    return GetField<int32_t>(VT_LOCALSIZE, 0);
  }
  bool mutate_localSize(int32_t _localSize) {
    return SetField<int32_t>(VT_LOCALSIZE, _localSize, 0);
  }
  float alpha() const {
...
struct ArgMax FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_outMaxVal(int32_t _outMaxVal) {
    return SetField<int32_t>(VT_OUTMAXVAL, _outMaxVal, 0);
  }
  int32_t topK() const {
    return GetField<int32_t>(VT_TOPK, 0);
  }
  bool mutate_topK(int32_t _topK) {
    return SetField<int32_t>(VT_TOPK, _topK, 0);
  }
  int32_t axis() const {
    return GetField<int32_t>(VT_AXIS, 0);
  }
  ...
  bool mutate_softmaxThreshold(int32_t _softmaxThreshold) {
    return SetField<int32_t>(VT_SOFTMAXTHRESHOLD, _softmaxThreshold, 0);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct Input FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_dformat(MNN_DATA_FORMAT _dformat) {
    return SetField<int8_t>(VT_DFORMAT, static_cast<int8_t>(_dformat), 2);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct LSTM FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_clippingThreshold(float _clippingThreshold) {
    return SetField<float>(VT_CLIPPINGTHRESHOLD, _clippingThreshold, 0.0f);
  }
  const Blob *weightI() const {
    return GetPointer<const Blob *>(VT_WEIGHTI);
  }
  Blob *mutable_weightI() {
    return GetPointer<Blob *>(VT_WEIGHTI);
  }
  const Blob *weightH() const {
    return GetPointer<const Blob *>(VT_WEIGHTH);
  }
  Blob *mutable_weightH() {
    return GetPointer<Blob *>(VT_WEIGHTH);
  }
  const Blob *bias() const {
    return GetPointer<const Blob *>(VT_BIAS);
  }
  Blob *mutable_bias() {
    return GetPointer<Blob *>(VT_BIAS);
  }
  const Blob *weightIQ() const {
    return GetPointer<const Blob *>(VT_WEIGHTIQ);
  }
  Blob *mutable_weightIQ() {
    return GetPointer<Blob *>(VT_WEIGHTIQ);
  }
  const Blob *weightIA() const {
    return GetPointer<const Blob *>(VT_WEIGHTIA);
  }
  Blob *mutable_weightIA() {
    return GetPointer<Blob *>(VT_WEIGHTIA);
  }
  float quantScale() const {
    return GetField<float>(VT_QUANTSCALE, 0.0f);
  }
...
struct Slice FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<int32_t> *mutable_slicePoints() {
    return GetPointer<flatbuffers::Vector<int32_t> *>(VT_SLICEPOINTS);
  }
  NetSource sourceType() const {
    return static_cast<NetSource>(GetField<int8_t>(VT_SOURCETYPE, 0));
  }
  bool mutate_sourceType(NetSource _sourceType) {
    return SetField<int8_t>(VT_SOURCETYPE, static_cast<int8_t>(_sourceType), 0);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_AXIS) &&
...
struct BatchNorm FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<float> *mutable_slopeData() {
    return GetPointer<flatbuffers::Vector<float> *>(VT_SLOPEDATA);
  }
  const flatbuffers::Vector<float> *meanData() const {
    return GetPointer<const flatbuffers::Vector<float> *>(VT_MEANDATA);
  }
  flatbuffers::Vector<float> *mutable_meanData() {
    return GetPointer<flatbuffers::Vector<float> *>(VT_MEANDATA);
  }
  const flatbuffers::Vector<float> *varData() const {
    return GetPointer<const flatbuffers::Vector<float> *>(VT_VARDATA);
  }
  flatbuffers::Vector<float> *mutable_varData() {
    return GetPointer<flatbuffers::Vector<float> *>(VT_VARDATA);
  }
  const flatbuffers::Vector<float> *biasData() const {
    return GetPointer<const flatbuffers::Vector<float> *>(VT_BIASDATA);
  }
  flatbuffers::Vector<float> *mutable_biasData() {
    return GetPointer<flatbuffers::Vector<float> *>(VT_BIASDATA);
  }
  const flatbuffers::Vector<float> *Adata() const {
    return GetPointer<const flatbuffers::Vector<float> *>(VT_ADATA);
  }
  flatbuffers::Vector<float> *mutable_Adata() {
    return GetPointer<flatbuffers::Vector<float> *>(VT_ADATA);
  }
  const flatbuffers::Vector<float> *Bdata() const {
    return GetPointer<const flatbuffers::Vector<float> *>(VT_BDATA);
  }
  flatbuffers::Vector<float> *mutable_Bdata() {
    return GetPointer<flatbuffers::Vector<float> *>(VT_BDATA);
  }
  float epsilon() const {
    return GetField<float>(VT_EPSILON, 0.001f);
  }
  bool mutate_epsilon(float _epsilon) {
    return SetField<float>(VT_EPSILON, _epsilon, 0.001f);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct Scale FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<float> *mutable_scaleData() {
    return GetPointer<flatbuffers::Vector<float> *>(VT_SCALEDATA);
  }
  const flatbuffers::Vector<float> *biasData() const {
    return GetPointer<const flatbuffers::Vector<float> *>(VT_BIASDATA);
  }
...
struct Eltwise FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_type(EltwiseType _type) {
    return SetField<int8_t>(VT_TYPE, static_cast<int8_t>(_type), 0);
  }
  const flatbuffers::Vector<float> *coeff() const {
    return GetPointer<const flatbuffers::Vector<float> *>(VT_COEFF);
  }
  flatbuffers::Vector<float> *mutable_coeff() {
    return GetPointer<flatbuffers::Vector<float> *>(VT_COEFF);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int8_t>(verifier, VT_TYPE) &&
...
struct Flatten FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_endAxis(int32_t _endAxis) {
    return SetField<int32_t>(VT_ENDAXIS, _endAxis, 0);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_AXIS) &&
...
struct Reshape FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_dimType(MNN_DATA_FORMAT _dimType) {
    return SetField<int8_t>(VT_DIMTYPE, static_cast<int8_t>(_dimType), 0);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_DIMS) &&
...
struct DetectionOutput FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_classCount(int32_t _classCount) {
    return SetField<int32_t>(VT_CLASSCOUNT, _classCount, 0);
  }
  float nmsThresholdold() const {
    return GetField<float>(VT_NMSTHRESHOLDOLD, 0.0f);
  }
  bool mutate_nmsThresholdold(float _nmsThresholdold) {
    return SetField<float>(VT_NMSTHRESHOLDOLD, _nmsThresholdold, 0.0f);
  }
  int32_t nmsTopK() const {
    return GetField<int32_t>(VT_NMSTOPK, 0);
  }
  bool mutate_nmsTopK(int32_t _nmsTopK) {
    return SetField<int32_t>(VT_NMSTOPK, _nmsTopK, 0);
  }
  int32_t keepTopK() const {
    return GetField<int32_t>(VT_KEEPTOPK, 0);
  }
  bool mutate_keepTopK(int32_t _keepTopK) {
    return SetField<int32_t>(VT_KEEPTOPK, _keepTopK, 0);
  }
  float confidenceThreshold() const {
    return GetField<float>(VT_CONFIDENCETHRESHOLD, 0.0f);
  }
  bool mutate_confidenceThreshold(float _confidenceThreshold) {
    return SetField<float>(VT_CONFIDENCETHRESHOLD, _confidenceThreshold, 0.0f);
  }
  int32_t shareLocation() const {
    return GetField<int32_t>(VT_SHARELOCATION, 0);
  }
  bool mutate_shareLocation(int32_t _shareLocation) {
    return SetField<int32_t>(VT_SHARELOCATION, _shareLocation, 0);
  }
  int32_t backgroundLable() const {
    return GetField<int32_t>(VT_BACKGROUNDLABLE, 0);
  }
  bool mutate_backgroundLable(int32_t _backgroundLable) {
    return SetField<int32_t>(VT_BACKGROUNDLABLE, _backgroundLable, 0);
  }
  int32_t varianceEncodedTarget() const {
    return GetField<int32_t>(VT_VARIANCEENCODEDTARGET, 0);
  }
  bool mutate_varianceEncodedTarget(int32_t _varianceEncodedTarget) {
    return SetField<int32_t>(VT_VARIANCEENCODEDTARGET, _varianceEncodedTarget, 0);
  }
  int32_t codeType() const {
    return GetField<int32_t>(VT_CODETYPE, 0);
  }
  bool mutate_codeType(int32_t _codeType) {
    return SetField<int32_t>(VT_CODETYPE, _codeType, 0);
  }
  float objectnessScore() const {
    return GetField<float>(VT_OBJECTNESSSCORE, 0.01f);
  }
  bool mutate_objectnessScore(float _objectnessScore) {
    return SetField<float>(VT_OBJECTNESSSCORE, _objectnessScore, 0.01f);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct RoiPooling FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_pooledWidth(int32_t _pooledWidth) {
    return SetField<int32_t>(VT_POOLEDWIDTH, _pooledWidth, 0);
  }
  int32_t pooledHeight() const {
    return GetField<int32_t>(VT_POOLEDHEIGHT, 0);
  }
  bool mutate_pooledHeight(int32_t _pooledHeight) {
    return SetField<int32_t>(VT_POOLEDHEIGHT, _pooledHeight, 0);
  }
  float spatialScale() const {
    return GetField<float>(VT_SPATIALSCALE, 0.0f);
  }
  bool mutate_spatialScale(float _spatialScale) {
    return SetField<float>(VT_SPATIALSCALE, _spatialScale, 0.0f);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct Proposal FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_featStride(int32_t _featStride) {
    return SetField<int32_t>(VT_FEATSTRIDE, _featStride, 0);
  }
  int32_t baseSize() const {
    return GetField<int32_t>(VT_BASESIZE, 0);
  }
  bool mutate_baseSize(int32_t _baseSize) {
    return SetField<int32_t>(VT_BASESIZE, _baseSize, 0);
  }
  int32_t preNmsTopN() const {
    return GetField<int32_t>(VT_PRENMSTOPN, 0);
  }
  bool mutate_preNmsTopN(int32_t _preNmsTopN) {
    return SetField<int32_t>(VT_PRENMSTOPN, _preNmsTopN, 0);
  }
  int32_t afterNmsTopN() const {
    return GetField<int32_t>(VT_AFTERNMSTOPN, 0);
  }
  bool mutate_afterNmsTopN(int32_t _afterNmsTopN) {
    return SetField<int32_t>(VT_AFTERNMSTOPN, _afterNmsTopN, 0);
  }
  float nmsThreshold() const {
    return GetField<float>(VT_NMSTHRESHOLD, 0.0f);
  }
  bool mutate_nmsThreshold(float _nmsThreshold) {
    return SetField<float>(VT_NMSTHRESHOLD, _nmsThreshold, 0.0f);
  }
  int32_t minSize() const {
    return GetField<int32_t>(VT_MINSIZE, 0);
  }
  bool mutate_minSize(int32_t _minSize) {
    return SetField<int32_t>(VT_MINSIZE, _minSize, 0);
  }
  const Blob *ratios() const {
    return GetPointer<const Blob *>(VT_RATIOS);
  }
  Blob *mutable_ratios() {
    return GetPointer<Blob *>(VT_RATIOS);
  }
  const Blob *scales() const {
    return GetPointer<const Blob *>(VT_SCALES);
  }
  Blob *mutable_scales() {
    return GetPointer<Blob *>(VT_SCALES);
  }
  const Blob *anchors() const {
    return GetPointer<const Blob *>(VT_ANCHORS);
  }
  Blob *mutable_anchors() {
    return GetPointer<Blob *>(VT_ANCHORS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct Interp FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_widthScale(float _widthScale) {
    return SetField<float>(VT_WIDTHSCALE, _widthScale, 0.0f);
  }
  float heightScale() const {
    return GetField<float>(VT_HEIGHTSCALE, 0.0f);
  }
  bool mutate_heightScale(float _heightScale) {
    return SetField<float>(VT_HEIGHTSCALE, _heightScale, 0.0f);
  }
  int32_t outputWidth() const {
    return GetField<int32_t>(VT_OUTPUTWIDTH, 0);
  }
  bool mutate_outputWidth(int32_t _outputWidth) {
    return SetField<int32_t>(VT_OUTPUTWIDTH, _outputWidth, 0);
  }
  int32_t outputHeight() const {
    return GetField<int32_t>(VT_OUTPUTHEIGHT, 0);
  }
  bool mutate_outputHeight(int32_t _outputHeight) {
    return SetField<int32_t>(VT_OUTPUTHEIGHT, _outputHeight, 0);
  }
  int32_t resizeType() const {
    return GetField<int32_t>(VT_RESIZETYPE, 0);
  }
  bool mutate_resizeType(int32_t _resizeType) {
    return SetField<int32_t>(VT_RESIZETYPE, _resizeType, 0);
  }
...
struct PriorBox FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<float> *mutable_minSizes() {
    return GetPointer<flatbuffers::Vector<float> *>(VT_MINSIZES);
  }
  const flatbuffers::Vector<float> *maxSizes() const {
    return GetPointer<const flatbuffers::Vector<float> *>(VT_MAXSIZES);
  }
  flatbuffers::Vector<float> *mutable_maxSizes() {
    return GetPointer<flatbuffers::Vector<float> *>(VT_MAXSIZES);
  }
  const flatbuffers::Vector<float> *aspectRatios() const {
    return GetPointer<const flatbuffers::Vector<float> *>(VT_ASPECTRATIOS);
  }
  flatbuffers::Vector<float> *mutable_aspectRatios() {
    return GetPointer<flatbuffers::Vector<float> *>(VT_ASPECTRATIOS);
  }
  ...
  bool mutate_imageWidth(int32_t _imageWidth) {
    return SetField<int32_t>(VT_IMAGEWIDTH, _imageWidth, 0);
  }
  int32_t imageHeight() const {
    return GetField<int32_t>(VT_IMAGEHEIGHT, 0);
  }
  bool mutate_imageHeight(int32_t _imageHeight) {
    return SetField<int32_t>(VT_IMAGEHEIGHT, _imageHeight, 0);
  }
  int32_t stepWidth() const {
    return GetField<int32_t>(VT_STEPWIDTH, 0);
  }
  bool mutate_stepWidth(int32_t _stepWidth) {
    return SetField<int32_t>(VT_STEPWIDTH, _stepWidth, 0);
  }
  int32_t stepHeight() const {
    return GetField<int32_t>(VT_STEPHEIGHT, 0);
  }
  bool mutate_stepHeight(int32_t _stepHeight) {
    return SetField<int32_t>(VT_STEPHEIGHT, _stepHeight, 0);
  }
  float offset() const {
...
struct Normalize FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_acrossSpatial(int32_t _acrossSpatial) {
    return SetField<int32_t>(VT_ACROSSSPATIAL, _acrossSpatial, 0);
  }
  int32_t channelShared() const {
    return GetField<int32_t>(VT_CHANNELSHARED, 0);
  }
  bool mutate_channelShared(int32_t _channelShared) {
    return SetField<int32_t>(VT_CHANNELSHARED, _channelShared, 0);
  }
  float eps() const {
