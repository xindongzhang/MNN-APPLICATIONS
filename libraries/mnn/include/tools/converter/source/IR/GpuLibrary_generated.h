...
struct GpuBuffer FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_access(ACCESS_TYPE _access) {
    return SetField<int8_t>(VT_ACCESS, static_cast<int8_t>(_access), 0);
  }
  STORAGE_TYPE storage() const {
    return static_cast<STORAGE_TYPE>(GetField<int8_t>(VT_STORAGE, 0));
  }
  bool mutate_storage(STORAGE_TYPE _storage) {
    return SetField<int8_t>(VT_STORAGE, static_cast<int8_t>(_storage), 0);
  }
  const Blob *content() const {
    return GetPointer<const Blob *>(VT_CONTENT);
  }
  Blob *mutable_content() {
    return GetPointer<Blob *>(VT_CONTENT);
  }
...
struct GpuPipeline FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<int32_t> *mutable_localSize() {
    return GetPointer<flatbuffers::Vector<int32_t> *>(VT_LOCALSIZE);
  }
  ...
  flatbuffers::Vector<int8_t> *mutable_metal() {
    return GetPointer<flatbuffers::Vector<int8_t> *>(VT_METAL);
  }
  const flatbuffers::Vector<int8_t> *vulkan() const {
    return GetPointer<const flatbuffers::Vector<int8_t> *>(VT_VULKAN);
  }
  flatbuffers::Vector<int8_t> *mutable_vulkan() {
    return GetPointer<flatbuffers::Vector<int8_t> *>(VT_VULKAN);
  }
  const flatbuffers::String *openglComputeShader() const {
    return GetPointer<const flatbuffers::String *>(VT_OPENGLCOMPUTESHADER);
  }
  flatbuffers::String *mutable_openglComputeShader() {
    return GetPointer<flatbuffers::String *>(VT_OPENGLCOMPUTESHADER);
  }
  const flatbuffers::String *openclKernel() const {
    return GetPointer<const flatbuffers::String *>(VT_OPENCLKERNEL);
  }
  flatbuffers::String *mutable_openclKernel() {
    return GetPointer<flatbuffers::String *>(VT_OPENCLKERNEL);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct GpuStage FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::String *mutable_pipeline() {
    return GetPointer<flatbuffers::String *>(VT_PIPELINE);
  }
  const flatbuffers::Vector<int32_t> *groupSize() const {
    return GetPointer<const flatbuffers::Vector<int32_t> *>(VT_GROUPSIZE);
  }
  flatbuffers::Vector<int32_t> *mutable_groupSize() {
    return GetPointer<flatbuffers::Vector<int32_t> *>(VT_GROUPSIZE);
  }
  const flatbuffers::Vector<int32_t> *inputIndexes() const {
    return GetPointer<const flatbuffers::Vector<int32_t> *>(VT_INPUTINDEXES);
  }
  flatbuffers::Vector<int32_t> *mutable_inputIndexes() {
    return GetPointer<flatbuffers::Vector<int32_t> *>(VT_INPUTINDEXES);
  }
  const flatbuffers::Vector<int32_t> *outputIndexes() const {
    return GetPointer<const flatbuffers::Vector<int32_t> *>(VT_OUTPUTINDEXES);
  }
  flatbuffers::Vector<int32_t> *mutable_outputIndexes() {
    return GetPointer<flatbuffers::Vector<int32_t> *>(VT_OUTPUTINDEXES);
  }
  ...
  flatbuffers::Vector<flatbuffers::Offset<GpuBuffer>> *mutable_middleBuffer() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<GpuBuffer>> *>(VT_MIDDLEBUFFER);
  }
  ...
  flatbuffers::Vector<flatbuffers::Offset<GpuBuffer>> *mutable_constBuffer() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<GpuBuffer>> *>(VT_CONSTBUFFER);
  }
  int32_t globalSizeIndex() const {
    return GetField<int32_t>(VT_GLOBALSIZEINDEX, 0);
  }
  bool mutate_globalSizeIndex(int32_t _globalSizeIndex) {
    return SetField<int32_t>(VT_GLOBALSIZEINDEX, _globalSizeIndex, 0);
  }
  ...
  flatbuffers::Vector<int32_t> *mutable_globalSizeDivide() {
    return GetPointer<flatbuffers::Vector<int32_t> *>(VT_GLOBALSIZEDIVIDE);
  }
  bool requireSize() const {
    return GetField<uint8_t>(VT_REQUIRESIZE, 0) != 0;
  }
  bool mutate_requireSize(bool _requireSize) {
    return SetField<uint8_t>(VT_REQUIRESIZE, static_cast<uint8_t>(_requireSize), 0);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct GpuFunction FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<flatbuffers::Offset<GpuStage>> *mutable_stags() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<GpuStage>> *>(VT_STAGS);
  }
...
struct GpuLibrary FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<flatbuffers::Offset<GpuFunction>> *mutable_functions() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<GpuFunction>> *>(VT_FUNCTIONS);
  }
  ...
  flatbuffers::Vector<flatbuffers::Offset<GpuPipeline>> *mutable_pipeline() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<GpuPipeline>> *>(VT_PIPELINE);
  }
  const flatbuffers::String *name() const {
    return GetPointer<const flatbuffers::String *>(VT_NAME);
  }
