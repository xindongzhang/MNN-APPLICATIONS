...
inline const char *EnumNameOpType(OpType e) {
  if (e < OpType_AbsVal || e > OpType_FloatToInt8) return "";
...
struct Plugin FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<flatbuffers::Offset<Blob>> *mutable_buffer() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<Blob>> *>(VT_BUFFER);
  }
...
struct Op FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_main_type(OpParameter _main_type) {
    return SetField<uint8_t>(VT_MAIN_TYPE, static_cast<uint8_t>(_main_type), 0);
  }
...
struct TensorDescribe FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  Blob *mutable_blob() {
    return GetPointer<Blob *>(VT_BLOB);
  }
  int32_t index() const {
...
struct Net FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::String *mutable_bizCode() {
    return GetPointer<flatbuffers::String *>(VT_BIZCODE);
  }
  ...
  flatbuffers::Vector<flatbuffers::Offset<TensorDescribe>> *mutable_extraTensorDescribe() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<TensorDescribe>> *>(VT_EXTRATENSORDESCRIBE);
  }
  const GpuLibrary *gpulibrary() const {
    return GetPointer<const GpuLibrary *>(VT_GPULIBRARY);
  }
  GpuLibrary *mutable_gpulibrary() {
    return GetPointer<GpuLibrary *>(VT_GPULIBRARY);
  }
  ...
  flatbuffers::Vector<flatbuffers::Offset<Op>> *mutable_oplists() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<Op>> *>(VT_OPLISTS);
  }
  ...
  flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *mutable_outputName() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *>(VT_OUTPUTNAME);
  }
  ForwardType preferForwardType() const {
    return static_cast<ForwardType>(GetField<int8_t>(VT_PREFERFORWARDTYPE, 0));
  }
  bool mutate_preferForwardType(ForwardType _preferForwardType) {
    return SetField<int8_t>(VT_PREFERFORWARDTYPE, static_cast<int8_t>(_preferForwardType), 0);
  }
  ...
  flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *mutable_tensorName() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *>(VT_TENSORNAME);
  }
  int32_t tensorNumber() const {
    return GetField<int32_t>(VT_TENSORNUMBER, 0);
  }
  bool mutate_tensorNumber(int32_t _tensorNumber) {
    return SetField<int32_t>(VT_TENSORNUMBER, _tensorNumber, 0);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
inline Net *GetMutableNet(void *buf) {
  return flatbuffers::GetMutableRoot<Net>(buf);
}
